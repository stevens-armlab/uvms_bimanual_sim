...
class VelocityControllerNode:
    def __init__(self):
        ...
        self.sub_cmd_vel_ang = rospy.Subscriber('cmd_vel_ang', numpy_msg(geometry_msgs.Twist), self.cmd_vel_ang_callback)
    ...
    def cmd_vel_callback(self, msg):
        ...
        self.v_angular_des[2] = v_a.z

    def cmd_vel_ang_callback(self, msg):
        v_a = msg.angular
        self.v_angular_des[0] = v_a.x
